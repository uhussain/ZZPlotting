filename="Hists26Feb2019-HZZ2018.root"
selection="HZZSelectionsTightLeps"
dir="Sync/HZZFull_18Feb2019"
...
do
  ...
  then
    ...
    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir} -b ${var} --preliminary --extra_text HZZSelections -a Full --no_overflow --scaleymax 1.2 --scalelegx 1.2 
    ...
    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/eeee -b ${var} -c eeee --preliminary --extra_text HZZSelections -a Full --no_overflow --scaleymax 1.2 --scalelegx 1.2 
    ...
    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/mmmm -b ${var} -c mmmm --preliminary --extra_text HZZSelections -a Full --no_overflow --scaleymax 1.2 --scalelegx 1.2 
    ...
    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/eemm -b ${var} -c eemm --preliminary --extra_text HZZSelections -a Full --no_overflow --scaleymax 1.2 --scalelegx 1.2 
    ...
    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/mmee -b ${var} -c mmee --preliminary --extra_text HZZSelections -a Full --no_overflow --scaleymax 1.2 --scalelegx 1.2 
    ...
    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/2e2m -b ${var} -c eemm,mmee --preliminary --extra_text HZZSelections -a Full --no_overflow --scaleymax 1.2 --scalelegx 1.2 
  fi
  ...
  then
    echo ${var}
    echo "All Channels"
    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir} -b ${var} --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2 
    ...
    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/eeee -b ${var} -c eeee --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2
    ...
    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/mmmm -b ${var} -c mmmm --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2 
    ...
    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/eemm -b ${var} -c eemm --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2 
    ...
    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/mmee -b ${var} -c mmee --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2
    ...
    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/2e2m -b ${var} -c eemm,mmee --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2
...
#    echo ${var}
#    echo "All Channels"
#    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --no_data --nostack --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir} -b ${var} --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2 
#     
#    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --no_data --nostack -a ZMass --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir} -b ${var} --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2 --rebin 80.0,82.0,84.0,86.0,88.0,90.0,92.0,94.0,96.0,98.0,100.0,102.0,104.0   
#    echo "Plotting 4e channel"
#    
#    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --no_data --nostack  --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/eeee -b ${var} -c eeee --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2
#    
#    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --no_data --nostack -a ZMass --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/eeee -b ${var} -c eeee --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2 --rebin 80.0,82.0,84.0,86.0,88.0,90.0,92.0,94.0,96.0,98.0,100.0,102.0,104.0   
#    echo "Plotting 4mu channel"
#    
#    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --no_data --nostack --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/mmmm -b ${var} -c mmmm --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2 
#    
#    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --no_data --nostack -a ZMass --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/mmmm -b ${var} -c mmmm --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2 --rebin 80.0,82.0,84.0,86.0,88.0,90.0,92.0,94.0,96.0,98.0,100.0,102.0,104.0   
#    echo "Plotting eemm channel"
#    
#    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --no_data --nostack --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/eemm -b ${var} -c eemm --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2 
#    
#    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --no_data --nostack -a ZMass --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/eemm -b ${var} -c eemm --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2 --rebin 80.0,82.0,84.0,86.0,88.0,90.0,92.0,94.0,96.0,98.0,100.0,102.0,104.0   
#    echo "Plotting mmee channel"
#    
#    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --no_data --nostack --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/mmee -b ${var} -c mmee --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2
#  
#    ./makeHistStack.py -s ZZ4l2019/${selection} -f ZZ4l2019NonPrompt -l 59.95 -u stat --legend_left --no_data --nostack -a ZMass --hist_file /afs/cern.ch/user/u/uhussain/ZZ4lHistFiles/${filename} --folder_name ${dir}/mmee -b ${var} -c mmee --preliminary --extra_text HZZSelections --scaleymax 1.2 --scalelegx 1.2 --rebin 80.0,82.0,84.0,86.0,88.0,90.0,92.0,94.0,96.0,98.0,100.0,102.0,104.0   
#  fi
