...
def stackplot(channels):
    ...
    if (ZZ4lSelection): 
        c.SaveAs("DataMCPlots_Aug14/Z1Mass_ZZ4lSelection_AllChannels_blinded_m4l_"+Date+".pdf")  
    else:
        c.SaveAs("DataMCPlots_Aug14/Z1Mass_FullSpectrum_AllChannels_blinded_m4l_"+Date+".pdf") 
    #text = raw_input()
