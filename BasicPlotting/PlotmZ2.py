...
def createDataH1(ch,channels):
    ...
    #Function to retrieve mZ1 in ch=eemm
        ...
        chain.Draw("(( abs(e1_e2_Mass-91.1876)<abs(m1_m2_Mass-91.1876) ) ? m1_m2_Mass : e1_e2_Mass)>>"+data_hist, "nZZTightIsoElec+nZZTightIsoMu==4")
...
def createMCStack(ch,channels):
    ...
    for mc_Sample in mcSamples.keys():
        ...
        #Function to retrieve mZ1 in ch=eemm
            ...
            MCchain.Draw("(( abs(e1_e2_Mass-91.1876)<abs(m1_m2_Mass-91.1876) ) ? m1_m2_Mass : e1_e2_Mass)>>"+hist_name, "genWeight*(nZZTightIsoElec+nZZTightIsoMu==4)")
...
def stackplot(ch,channels):
    ...
    #pad2.cd()
    #h3.Draw("ep")
    c.SaveAs("DataMCPlots_Mar15/Z2Mass_"+ch+"_m4l_"+Date+".pdf") 
    #text = raw_input()
